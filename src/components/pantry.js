...
const Pantry = ({pantryLoad, shoppingLoad, recipeLoad, accountLoad}) => {
    let produce = pantrySet.filter(item => item.type === 'produce');
        ...
        <div className='pantry-grid'>
            {pantrySet.map((item) => (
                <div key={item.id} className='pantry-item'>
                    ...
                    <p className='pantry-overlay'>{item.category}</p>
                    </button>
                </div>
            ))}
        </div>     
    ...
    let pantryHome = (
        <div className='layout'>
            ...
            <div className='cat-bar'>
                ...
                <button className='cat-button'>Produce</button>
                <button className='cat-button'>Proteins</button>
                <button className='cat-button'>Dairy</button>
                <button className='cat-button'>Grains</button>
                <button className='cat-button'>Canned</button>
                <button className='cat-button'>Condiments</button>
                <button className='cat-button'>Beverages</button>
                <button className='cat-button'>Frozen</button>
                <button className='cat-button'>Snacks</button>
                <button className='cat-button'>Other</button>
            </div>
            {grid}
