  ...
  let shoppingPage = (
    <div className='layout'>
          ...
          {close => (
            <div>
              <div className='content'>
                <p className='popup-text2'>Remove checked items from shopping list?</p>
              </div>
              <div>
      ...
      <div className='navbar'>
        ...
        <button className='nav-button-active' onClick={shoppingLoad}><svg width="65" height="59" viewBox="0 0 65 59" fill="none" xmlns="http://www.w3.org/2000/svg">
